...
class CustomCountry(db.Model):
    ...
    timezones: Mapped[str] = mapped_column(String(40), nullable=False)
    currencies: Mapped[str] = mapped_column(String(3), nullable=False)
    languages: Mapped[str] = mapped_column(String(40), nullable=False)
    capital: Mapped[str] = mapped_column(String(40), nullable=False)
    population: Mapped[int] = mapped_column(Integer, nullable=False)
    region: Mapped[str] = mapped_column(String(40), nullable=False)
    subregion: Mapped[str] = mapped_column(String(40), nullable=False)
    wiki_link: Mapped[str] = mapped_column(String, nullable=False)
